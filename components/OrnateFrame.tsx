export default function OrnateFrame() {
  return (
    ...
    >
      ...
      {/* Corner fleur */}
      <circle cx="14" cy="14" r="4" fill="url(#gold)" />
      <path d="M10,14 L18,14 M14,10 L14,18" stroke="url(#gold)" strokeWidth="1.5"/>
      ...
      <circle cx="386" cy="14" r="4" fill="url(#gold)" />
      <path d="M382,14 L390,14 M386,10 L386,18" stroke="url(#gold)" strokeWidth="1.5"/>
      ...
      <circle cx="14" cy="386" r="4" fill="url(#gold)" />
      <path d="M10,386 L18,386 M14,382 L14,390" stroke="url(#gold)" strokeWidth="1.5"/>
      ...
      <circle cx="386" cy="386" r="4" fill="url(#gold)" />
      <path d="M382,386 L390,386 M386,382 L386,390" stroke="url(#gold)" strokeWidth="1.5"/>
      ...
      <circle cx="200" cy="6" r="3.5" fill="url(#gold)" />
      ...
      <circle cx="200" cy="394" r="3.5" fill="url(#gold)" />
      ...
      <circle cx="6" cy="200" r="3.5" fill="url(#gold)" />
      ...
      <circle cx="394" cy="200" r="3.5" fill="url(#gold)" />
    </svg>
  );
}
